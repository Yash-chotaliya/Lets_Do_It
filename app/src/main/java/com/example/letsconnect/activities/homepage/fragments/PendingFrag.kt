...
import com.example.letsconnect.databinding.FragmentPendingBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*

class PendingFrag : Fragment(),ITaskAdapter {
        ...
        dbRef.child("Tasks").addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if(list.isEmpty())
                    ...
                    binding.rv.adapter = TaskAdapter(list,this@PendingFrag)
                }
